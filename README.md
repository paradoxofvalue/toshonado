#  Краткое how-to
## если нужно отредактировать контент (переводы)
* лезем в /index.html и в первую очередь редактируйте там (там контекст который индексируется)
* лезем в /src/js/modules/lang.js и редактируем там (тут все переводы)



[Web Starter Kit](https://github.com/justcoded/web-starter-kit/releases)
